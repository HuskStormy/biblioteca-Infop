...
@section('TITULO_PAGINA', 'Agregar Ficha ')
@section('PAG_GRUPO', 'Gestion de procesos')
@section('content')
...
<nav class="nav nav-tabs">
    <a class="nav-link nav-dest active" href="#" data-target="section1">Crear Ficha</a>
...
<div id="section1" class="content-section active">
    ...
    <form id="formSection1">
        ...
        <label for="usuario">Coloque la hora:</label> 
