...
@section('TITULO_PAGINA', 'Repositorio de Inventario')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0">Inventario de Multimedia  Biblioteca</h5>
                ...
                <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Uso del torno </td>
                            <td>AVI</td>
                            <td>Explicacion de uso Correcto del torno</td>
                            <td>100-45</td>
                            <td>15/12/24</td>
                            <td>5:00 pm</td>
                            <td>4589</td>
